...
public class StoryFreshActivity extends Activity {
...
//        graphic_design, seo, socialmarketing,motion_graphics
        ...
        getData = (Button) findViewById(R.id.btn_getServerData);
    }
    ...
    private class LongOperation extends AsyncTask<String, Void, Void> {
        ...
        private ProgressDialog Dialog = new ProgressDialog(StoryFreshActivity.this);
